...
void BSP_Init(void){
    HAL_ADC_Start_DMA(&hadc1, (uint32_t*)joystick_adc, 2); //bật chế độ tự động đọc dữ liệu từ ADC đưa vào mảng
    // THÊM LỆNH NÀY: Khởi động bộ phát xung PWM trên Kênh 1 của Timer 4
